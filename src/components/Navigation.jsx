export default function Navigation({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-40">
      ...
      {/* Prev/Next */}
      <div className="pointer-events-auto absolute bottom-20 left-0 right-0 flex items-center justify-between px-4 md:px-8">
        <button
          type="button"
          onClick={onPrev}
          disabled={atStart}
          className="oyw-glass rounded-full px-4 py-3 text-sm font-bold text-[#2a0e1c] shadow-glow transition-opacity disabled:opacity-40"
